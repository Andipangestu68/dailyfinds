...
//             <h1 className="text-3xl font-bold">Shopee Affiliate Catalog</h1>
//             <div className="flex gap-4 items-center">
//               {session && (
//                 <>
//                   <span className="text-sm">
//                     {session.user.email} {userRole === 'admin' && '(Admin)'}
//                   </span>
//                   {userRole === 'admin' && (
//                     <button
...
//       {/* Search Section */}
//       <div className="bg-white border-b-4 border-black shadow-md">
//         <div className="container mx-auto px-4 py-8">
//           <h2 className="text-2xl font-bold mb-6">Find Your Product</h2>
...
//                   <div className="p-4">
//                     <div className="mb-2">
//                       <span className="bg-gray-200 text-xs px-2 py-1 rounded font-bold">
//                         {product.category}
//                       </span>
//                     </div>
...
//                       className="w-full bg-accent hover:bg-orange-600 text-white py-2 rounded-lg font-bold transition-colors"
//                     >
//                       View on Shopee
//                     </button>
//                   </div>
...
//           <p>&copy; 2024 Shopee Affiliate Catalog. All rights reserved.</p>
//         </div>
//       </footer>
//     </div>
//   );
